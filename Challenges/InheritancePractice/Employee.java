...
public class Employee extends Person {
    ...
    public Employee (String first, String last, double payRate, String department) {
    ...
    public String toString() {
       ...
       return "\nThe wages for " + super.toString() + " from the " + department + " department are " + calculatePay();
    ...
    public void print() {
        ...
        System.out.println("\nThe employee " + super.toString() + " worked " + hoursWorked + " hours with a pay rate of $" + payRate + ". The wages for this employee are $" + calculatePay());
    }
    ...
    public double calculatePay() {
        ...
        return (double)hoursWorked * payRate + ((double)(hoursWorked - HOURS) * payRate * OVERTIME);
    }
